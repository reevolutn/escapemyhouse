...
sv = {
	...
	populateGoogleImage : function() {
		...
		sv.videos.videosmoke.src = u.videoStream+'house_smoke.v2.mp4';
		...
		sv.videos.videofire.src = u.videoStream+'house_fire.v2.mp4';
	...
	placeObjects : function() {
	    ...
	    sv.objects.smokeVideo.position.z = -.2;
	    ...
	    sv.objects.fireVideo.position.z = -.1;
