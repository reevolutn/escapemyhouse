...
modals.content.lounge = {
	...
	intro : {
		img : {
			desktop : '/assets/img/modals/v3/_0000_desktop.png',
			mobile : '/assets/img/modals/v3/_0002_mobile.png',
			vr : '/assets/img/modals/v3/_0001_vr.png'
		},
	...
	gaming : {
		img : '/assets/img/modals/v3/_0002_modal-gaming-over.png',
	...
	game_clicked : {
		img : '/assets/img/modals/v3/_0003_modal-gaming-click.png',
		btn : false, //'/assets/img/buttons/_0002_btn-gotit.png',
		onclick : function() {
	...
	heater : {
		img : '/assets/img/modals/v3/_0000_modal-heater-over.png',
		btn : false,
		onclick : false,
		onmouseover : function() {
	...
	next_room : {
		img : '/assets/img/modals/v3/_0005_modal-nextroom-over.png',
		...
		onclick : function() {
			...
			modals.killAll();
			timer.videoStart = ex.videos.toload.currentTime; 
	...
	couch : {
		img : '/assets/img/modals/v3/_0001_modal-loungechair-over.png',
		btn : false,
		onclick : false,
		onmouseover : function() {
			modals.fadeIn('couch');
	...
	album : {
		img : '/assets/img/modals/v3/_0016_modal-photoalbum.png',
		btn : false, //'/assets/img/buttons/_0003_btn-pickup.png',
		onclick : function() {
			modals.close('album');
	...
	alb_clicked : {
		img : '/assets/img/modals/v3/_0017_modal-photoalbum-over.png',
		btn : false, //'/assets/img/buttons/_0002_btn-gotit.png',
		onclick : function() {
	...
	exit_window : {
		img : '/assets/img/modals/v3/_0004_modal-exit-over.png',
...
modals.content.hallway = {
	...
	lounge : {
		img : '/assets/img/modals/v3/_0006_modal-loungetemp.png',
		btn : false,
		onclick : false,
		onmouseover : function() {
	...
	hallway_fire : {
		img : '/assets/img/modals/v3/_0007_modal-hallwayfire.png',
		btn : false,
		onclick : false,
		onmouseover : function() {
	...
	no_exit : {
		img : '/assets/img/modals/v3/_0008_modal-noexithere.png',
		btn : false,
		onclick : false,
		onmouseover : function() {
	...
	bojangles : {
		img : '/assets/img/modals/v3/_0009_modal-bojangles.png',
		btn : false, //'/assets/img/buttons/_0003_btn-pickup.png',
		onclick : function() {
	...
	boj_clicked : {
		img : '/assets/img/modals/v3/_0010_modal-bojangles-over.png',
		btn : false, //'/assets/img/buttons/_0002_btn-gotit.png',
		onclick : function() {
	...
	tablet : {
		img : '/assets/img/modals/v3/_0014_modal-tablet.png',
		btn : false, //'/assets/img/buttons/_0003_btn-pickup.png',
		onclick : function() {
			modals.close('tablet');
			//modals.show('boj_clicked');
	...
	keys : {
		img : '/assets/img/modals/v3/_0013_modal-carkeys.png',
		btn : false, //'/assets/img/buttons/_0003_btn-pickup.png',
		onclick : function() {
			modals.close('keys');
	...
	key_clicked : {
		img : '/assets/img/modals/v3/_0015_modal-keys-over.png',
		btn : false, //'/assets/img/buttons/_0002_btn-gotit.png',
		onclick : function() {
	...
	locked_door : {
		img : '/assets/img/modals/v3/_0011_modal-lockeddoor.png',
		btn : false,
		onclick : function() {
	...
	exit_door : {
		img : '/assets/img/modals/v3/_0012_modal-exithouse.png',
		btn : false, //'/assets/img/buttons/_0000_btn-exit-house.png',
		onclick : function() {
