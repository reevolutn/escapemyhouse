...
u = {
	...
	videoLoaded : function(e) {
		...
		if(obj.buffered != null && obj.readyState != 0 && obj.readyState != 1) {
			u.videoPerLoaded = (obj.buffered.end(0) / obj.duration);
			$('#per_output').html('Loading... '+Math.round( ((u.videoPerLoaded*100)+u.videoPerLoadedOver)*3)+'%');
		} else {
			u.videoPerLoaded = 0;
		}
		console.log("loading "+obj.readyState+' - '+e.target.currentSrc+": "+u.videoPerLoaded);
