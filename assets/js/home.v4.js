...
hm = {
	...
	create : function() {
		...
		if(u.bandwidth != 'high' || detect.os.name == 'ios') {
			hm.videos.smokevideo.src = u.videoStream+'473336032.mp4'; //smoke_v2_lowres
		} else {
			hm.videos.smokevideo.src = u.videoStream+'473336032.mp4'; //smoke_v2
		}
	...
	placeTitle : function(smokevideo) {
		...
		var width = 7;
		var height = width/5;
		var titleimg = "/assets/img/landing/title.v2.png";
		var y = 0;

		if(u.d.w < 480) {
			width = 4;
			height = 4;
			titleimg = "/assets/img/landing/title-mob.v2.png";
			y = .5;
		}
		var z = 5;
