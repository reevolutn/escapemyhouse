...
ex = {
	...
	placeAudio : function() {
		...
		if(ex.videos.current == 'lounge') {
			...
			//place sounds
			ex.audio.fire_crackle = new BABYLON.Sound("fire_crackle", u.audioBase+"lounge/Fire Crackle.mp3", ex.scene, ex.soundReadyCallback, params);
			...
			ex.audio.fire_sfx = new BABYLON.Sound("fire_sfx", u.audioBase+"lounge/Fire SFX.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.fire_sfx.setPosition(new BABYLON.Vector3(-12, 0, 11));
			ex.audio.fire_sfx.setVolume(basevol*1.5);
			//add to the toal sound count
			ex.sounds.total ++;

			ex.audio.alarm = new BABYLON.Sound("alarm", u.audioBase+"lounge/Fire Alarm.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.alarm.setPosition(new BABYLON.Vector3(0, 11, 0));
			ex.audio.alarm.setVolume(basevol*.1);
			//add to the toal sound count
			ex.sounds.total ++;

			ex.audio.glass = new BABYLON.Sound("glass", u.audioBase+"lounge/Glass breaking four times.mp3", ex.scene, ex.soundReadyCallback, params);
			...
			//place sounds
			ex.audio.fire_crackle = new BABYLON.Sound("fire_crackle", u.audioBase+"hallway/Fire Crackle.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.fire_crackle.setPosition(new BABYLON.Vector3(-12, 0, 11));
			ex.audio.fire_crackle.setVolume(basevol);
			//add to the toal sound count
			ex.sounds.total ++;

			ex.audio.fire_sfx = new BABYLON.Sound("fire_sfx", u.audioBase+"hallway/FIre job Hallway Fire SFX.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.fire_sfx.setPosition(new BABYLON.Vector3(-12, 0, 11));
			ex.audio.fire_sfx.setVolume(basevol*1.5);
			//add to the toal sound count
			ex.sounds.total ++;

			ex.audio.alarm = new BABYLON.Sound("alarm", u.audioBase+"hallway/Fire Alarm.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.alarm.setPosition(new BABYLON.Vector3(0, 11, 0));
			ex.audio.alarm.setVolume(basevol*.1);
			//add to the toal sound count
			ex.sounds.total ++;

			ex.audio.glass = new BABYLON.Sound("glass", u.audioBase+"hallway/FIre job Hallway Windows breaking.mp3", ex.scene, ex.soundReadyCallback, params);
			ex.audio.glass.setPosition(new BABYLON.Vector3(-13, 0, -5));
	...
	virtualPointer : function(scene) {
		...
		pointerMaterial.diffuseTexture = new BABYLON.Texture(u.imageBase+"pointer.v4.png", scene);
	...
	placeSafeZone : function() {
		...
		safezoneMat.diffuseTexture = new BABYLON.Texture(u.imageBase+'safezone.png', ex.scene);
		...
		safezoneTitleMat.diffuseTexture = new BABYLON.Texture(u.imageBase+'safezone-title.png', ex.scene);
