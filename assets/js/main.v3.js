...
u = {
	...
	createPanel : function(name,img, scene, rotation, button1, button2) {
		...
		if(button1) {
			...
			btn1.diffuseTexture = new BABYLON.Texture('/assets/img/buttons/'+button1.buttonImage, scene);
		...
		if(button2) {
			...
			btn2.diffuseTexture = new BABYLON.Texture('/assets/img/buttons/'+button2.buttonImage, scene);
