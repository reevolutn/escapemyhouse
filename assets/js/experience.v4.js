...
ex = {
	...
	createScene : function () {
	    ...
	    ex.objects.pointLight1 = new BABYLON.PointLight("pointLight1", new BABYLON.Vector3(-12, 0, 0), scene);
	    ...
	    ex.objects.pointLight2 = new BABYLON.PointLight("pointLight2", new BABYLON.Vector3(0, 2, -10), scene);
	    ...
	    ex.objects.videoSphere = BABYLON.Mesh.CreateSphere("video_sphere", 32, 32, scene);
	...
	populateVideo : function(video) {
		...
		//dispose existing video
		if(typeof ex.objects.sphereVideo == 'undefined') {
	...
	destroy : function() {
		...
		ex.objects.sphereVideo.video.pause();
		$('#video_content,#video_content2').html('');
