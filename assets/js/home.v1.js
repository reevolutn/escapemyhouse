...
hm = {
	...
	createScene : function() {
	    ...
	    hm.cameras.desktop.fov = 1.5;
	   	...
	   	//attach control
	    //scene.activeCamera.attachControl(hm.canvas, true);
	...
	placeTitle : function(smokevideo) {
		...
		hm.objects.videoSmokeMat.alpha = .5;
		...
		hm.objects.videoSmokeMat2.alpha = .99;
		hm.objects.videoSmoke2.material = hm.objects.videoSmokeMat2;

		hm.objects.videoSmokeMat2.diffuseTexture.video.play();


		//hm.objects.videoSmoke1.rotation.z = Math.PI
		//hm.objects.videoSmoke2.rotation.z = Math.PI

		// hm.objects.videoSmoke = BABYLON.Mesh.CreateSphere("video_sphere", 32, 32, hm.scene);
		// //create mat
		// hm.objects.videoSmokeMat = new BABYLON.StandardMaterial("mat", hm.scene);
		// hm.objects.videoSmokeMat.backFaceCulling = false;
		// hm.objects.videoSmokeMat.emissiveColor = new BABYLON.Color3(1,1,1);
		...
		// //assign video
		// hm.objects.videoSmokeMat.diffuseTexture = new BABYLON.VideoTexture("video", ["/assets/img/google/smoke.mp4"], hm.scene, true, true);
		// hm.objects.videoSmoke.material = hm.objects.videoSmokeMat;
		// hm.objects.videoSmokeMat.diffuseTexture.video.play();
